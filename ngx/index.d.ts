...
export interface HotCodePushDownProgress {
  current: number
  total: number
}
...
export interface HcpInstallOptions {
  /**
   * 是否需要在安装完成后立即重启
   */
  reload?: boolean
...
export declare class HotCodePush extends IonicNativePlugin {
   ...
   */
  installUpdate(options?: HcpInstallOptions): Promise<any>
  /**
   ...
   * @returns {Observable<HotCodePushEventData>}
   */
  downloadProgress(): Observable<HotCodePushDownProgress>
}
